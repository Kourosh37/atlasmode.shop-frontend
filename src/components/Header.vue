...
<template>
  <header class="fixed top-0 left-0 w-full z-50 bg-white shadow-sm" dir="rtl">
    <div class="flex flex-row items-center justify-between py-2 px-4 md:px-8 md:py-4">
      ...
      <nav class="hidden md:flex items-center justify-center gap-6 text-gray-800 text-base font-sm w-1/3">
        ...
        <a href="#" class="hover:text-black">بلاگ</a>
        <a href="#" class="hover:text-black">رهگیری پستی</a>
        <a href="#" class="hover:text-black">درباره ما</a>
        <a href="#" class="hover:text-black">تماس با ما</a>
      </nav>
    ...
    <transition name="fade">
      <div v-if="showMenu" class="fixed z-[200] top-0 left-0 w-full h-full bg-black/40 flex">
        <div class="bg-white w-4/5 max-w-xs h-full p-6 pt-8 flex flex-col gap-6" dir="rtl">
          ...
          <a href="#" class="flex items-center gap-2 mb-2 text-lg font-semibold">
            <span class="h-2 w-2 rounded-full bg-black"></span> لباس زنانه
          </a>
          <a href="#" class="flex items-center gap-2 mb-2 text-lg font-semibold">
            <span class="h-2 w-2 rounded-full bg-black"></span> بلاگ
          </a>
          <a href="#" class="flex items-center gap-2 mb-2 text-lg font-semibold">
            <span class="h-2 w-2 rounded-full bg-black"></span> رهگیری پستی
          </a>
          <a href="#" class="flex items-center gap-2 mb-2 text-lg font-semibold">
            <span class="h-2 w-2 rounded-full bg-black"></span> درباره ما
          </a>
          <a href="#" class="flex items-center gap-2 mb-2 text-lg font-semibold">
            <span class="h-2 w-2 rounded-full bg-black"></span> تماس با ما
          </a>
        </div>

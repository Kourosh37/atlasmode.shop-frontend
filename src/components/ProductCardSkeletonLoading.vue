<template>
  <div class="bg-white rounded-2xl shadow relative flex flex-col items-center min-w-[220px] h-[430px] overflow-hidden">
    <!-- تصویر محصول (اسکلتون) -->
    <div class="w-full h-64 bg-gray-200 animate-shine rounded-2xl"></div>
